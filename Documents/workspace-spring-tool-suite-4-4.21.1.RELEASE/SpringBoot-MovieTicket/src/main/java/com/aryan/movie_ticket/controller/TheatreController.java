...
import com.aryan.movie_ticket.dto.Seat;
...
import com.aryan.movie_ticket.repository.ScreenRepository;
...
public class TheatreController
{
	...
	public String signup(@Valid Theatre theatre , BindingResult result,HttpSession session)
	{
		...
		if(customerRepository.existsByEmail(theatre.getEmail()) || theatreRepository.existsByEmail(theatre.getEmail()))
		{
			result.rejectValue("email", "error.email", "* Account Already Exist");
		}
		if(customerRepository.existsByMobile(theatre.getMobile()) || theatreRepository.existsByMobile(theatre.getMobile()))
		{
